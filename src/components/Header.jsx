    ...
    >
      <div className="flex items-center py-5 px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav
          ...
          } fixed top-[7rem] left-0 right-0 bottom-0 bg-primary lg:static lg:flex lg:mx-auto lg:bg-transparent`}
        >
          <div className="relative z-2 flex flex-col items-center justify-center m-auto lg:flex-row">
            {navigation.map((item) => (
              <a
                ...
                } px-6 py-4 text-center md:py-8 lg:-mr-0.25 lg:text-xs lg:font-semibold ${
